...
import { counties, subCounties, wards } from "../data/kenyaLocations.jsx";
import { useAuth } from '../contexts/AuthContext.jsx';
import { saveCensusData } from '../services/censusService.jsx';
...
function CensusForm({ onToggleTheme, mode }) {
  const { currentUser, logout } = useAuth(); // <-- Add logout
